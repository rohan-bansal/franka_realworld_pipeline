...
class DiffusionPolicyConfig(BaseConfig):
    ...
    def algo_config(self):
        ...
        self.train.load_ckpt = None
        self.train.epoch_start = 0
        ...
        # Receding Horizon
        self.algo.future_action_condition.enabled = False
        self.algo.future_action_condition.horizon = 4
        self.algo.future_action_condition.binary_mask = False
        self.algo.future_action_condition.p_cond = 0.1 # probability of nullifying action condition for CFG
        self.algo.future_action_condition.weight = 1.0 # weight of action condition for CFG
        self.algo.future_action_condition.null_token = 'zero' # null token for action condition for CFG
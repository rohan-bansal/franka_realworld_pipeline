...
def write_intervention_segments_as_trajectories(
    ...
    keys_to_try_and_copy = ["states", "obs", "next_obs", "rewards", "dones", "actions_abs", 
                            "datagen_info", "joint_position_actions", "delta_joint_actions", "delta_axis_angle_actions", 
                            "absolute_axis_angle_actions", "absolute_actions", "gripper_action"]

...
if __name__ == "__main__":
    ...
    if args.video_path is None:
        ...
        args.video_path = os.path.abspath(
            os.path.join(args.video_dir, f"quick_test_receding_horizon_{datetime.datetime.now()}.mp4"))
    ...
    if args.dataset_path is None:
        ...
        args.dataset_path = os.path.join(dataset_dir, f"quick_test_receding_horizon_{datetime.datetime.now()}.pkl")
        # args.dataset_path = os.path.abspath(os.path.join(os.path.dirname(args.agent), '..', 'logs',

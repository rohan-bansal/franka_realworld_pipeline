...
def rollout_diffusion_policy(policy, env, horizon, render=False, video_writer=None, video_skip=5, return_obs=False,
    ...
    total_reward = 0.
    traj = dict(executed_actions=[], preds=[], rewards=[], dones=[], states=[], obs=[], control_freqs=[], dt=[], initial_state_dict=state_dict)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--agent",
        type=str,
        default="/nethome/nkra3/flash7/phd_project/robomimic-nadun/bc_trained_models/diffusion_policy/sim/speed_adaptive_models_commanded_pose/absolute_osc/square_image_action_horizon_16_speed_adaptive/20250108125500/models/model_epoch_1000.pth",
        required=False,
    ...
    parser.add_argument(
        ...
        type=str,
        # default=None,
        default="/nethome/nkra3/flash7/phd_project/robomimic-nadun/datasets/square/ph/square_init_states.pkl",
    ...
    parser.add_argument(
        '--config',
        type=str,
        default="/home/wjung85/Repo/projects/FastIL/robomimic/dev/hparam/square_inpaint/base_config_square.json",
    ...
    if args.video_dir is None:
        args.video_dir = os.path.abspath(os.path.join(os.path.dirname(args.agent), '..', 'videos/hparam_adaptive_fixed'))
    ...
    for iter in range(args.N_eval):
        ...
        if args.dataset_path is None:
            dataset_dir = os.path.abspath(os.path.join(os.path.dirname(args.agent), '..', 'logs/hparam_adaptive_fixed'))

#!/bin/bash
#SBATCH --job-name=square_convex_4
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/rss_dev/blended_inpainting/square_convex_4.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/rss_dev/blended_inpainting/square_convex_4.err

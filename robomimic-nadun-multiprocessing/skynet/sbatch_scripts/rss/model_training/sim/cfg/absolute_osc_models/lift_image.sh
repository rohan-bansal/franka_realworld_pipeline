...
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/rss_training/sim/cfg/absolute_osc/lift_image.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/rss_training/sim/cfg/absolute_osc/lift_image.err

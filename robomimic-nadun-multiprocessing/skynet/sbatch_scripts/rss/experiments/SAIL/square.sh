#!/bin/bash
#SBATCH --job-name=square_SAIL
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/rss_experiments/SAIL/square_SAIL.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/rss_experiments/SAIL/square_SAIL.err

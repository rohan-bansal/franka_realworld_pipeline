#!/bin/bash
#SBATCH --job-name=lift_SAIL
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/rss_experiments/SAIL/lift_SAIL.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/rss_experiments/SAIL/lift_SAIL.err

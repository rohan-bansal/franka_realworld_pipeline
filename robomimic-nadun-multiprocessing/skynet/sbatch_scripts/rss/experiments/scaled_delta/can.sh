#!/bin/bash
#SBATCH --job-name=can_scale_15_uncapped
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/rss_experiments/scaled_delta/can_scale_15_uncapped.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/rss_experiments/scaled_delta/can_scale_15_uncapped.err

#!/bin/bash
#SBATCH --job-name=lift_eval_over_kp_fast
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/rss_experiments/eval_over_kp/lift_fast.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/rss_experiments/eval_over_kp/lift_fast.err

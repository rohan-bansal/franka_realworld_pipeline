#!/bin/bash
#SBATCH --job-name=square_high_gain_eval
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/rss_experiments/normal_eval/square_high_gain_eval.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/rss_experiments/normal_eval/square_high_gain_eval.err

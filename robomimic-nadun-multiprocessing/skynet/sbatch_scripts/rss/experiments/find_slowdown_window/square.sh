#!/bin/bash
#SBATCH --job-name=square_slowdown_window
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/rss_experiments/slowdown_window/square.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/rss_experiments/slowdown_window/square.err

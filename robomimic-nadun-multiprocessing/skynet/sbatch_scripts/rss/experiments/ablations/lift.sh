#!/bin/bash
#SBATCH --job-name=lift_without_consistency_guiding
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/rss_experiments/ablations/lift_without_consistency_guiding.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/rss_experiments/ablations/lift_without_consistency_guiding.err

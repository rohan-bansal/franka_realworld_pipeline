#!/bin/bash
#SBATCH --job-name=lift_high_gain_noisy
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/rss_experiments/noise_vs_gain/lift_high_gain_noisy.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/rss_experiments/noise_vs_gain/lift_high_gain_noisy.err

#!/bin/bash
#SBATCH --job-name=lift_image_control_freq_eval
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/eval/lift_image_control_freq_eval.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/eval/lift_image_control_freq_eval.err

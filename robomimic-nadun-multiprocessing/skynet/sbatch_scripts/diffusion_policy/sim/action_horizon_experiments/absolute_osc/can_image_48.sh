#!/bin/bash
#SBATCH --job-name=can_image_action_horizon_48
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/sim/action_horizon_experiments/absolute_osc/can_image_action_horizon_48.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/sim/action_horizon_experiments/absolute_osc/can_image_action_horizon_48.err

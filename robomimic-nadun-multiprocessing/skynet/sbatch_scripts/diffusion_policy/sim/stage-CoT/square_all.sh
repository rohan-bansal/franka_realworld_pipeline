#!/bin/bash
#SBATCH --job-name=square_image_3k
#SBATCH --output=/coc/flash7/zhenyang/logs/sim/square/square_all_image_3k_0602_test.out
#SBATCH --error=/coc/flash7/zhenyang/logs/sim/square/square_all_image_3k_0602_test.err

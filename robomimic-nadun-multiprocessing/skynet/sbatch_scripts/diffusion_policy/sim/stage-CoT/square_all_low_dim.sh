#!/bin/bash
#SBATCH --job-name=square_low_dim
#SBATCH --output=/coc/flash7/zhenyang/logs/sim/square/square_all_low_dim_0602.out
#SBATCH --error=/coc/flash7/zhenyang/logs/sim/square/square_all_low_dim_0602.err
...
config="square_osc_low_dim.json"

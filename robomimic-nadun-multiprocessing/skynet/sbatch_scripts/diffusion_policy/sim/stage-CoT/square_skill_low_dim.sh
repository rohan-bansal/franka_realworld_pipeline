#!/bin/bash
#SBATCH --job-name=square_skill_low_dim_0602
#SBATCH --output=/coc/flash7/zhenyang/logs/sim/square/square_skill_low_dim_0602.out
#SBATCH --error=/coc/flash7/zhenyang/logs/sim/square/square_skill_low_dim_0602.err
...
config="square_skill_osc_low_dim.json"

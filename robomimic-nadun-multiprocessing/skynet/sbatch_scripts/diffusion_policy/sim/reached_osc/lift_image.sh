#!/bin/bash
#SBATCH --job-name=robomimic_lift_Image_reached_pose
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/sim/reached_osc/robomimic_lift_Image_reached_pose.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/sim/reached_osc/robomimic_lift_Image_reached_pose.err

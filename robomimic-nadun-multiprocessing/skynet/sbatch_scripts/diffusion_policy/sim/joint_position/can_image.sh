#!/bin/bash
#SBATCH --job-name=robomimic_can_Image_joint_actions
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/sim/joint_positions/robomimic_can_Image_joint_actions.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/sim/joint_positions/robomimic_can_Image_joint_actions.err

#!/bin/bash
#SBATCH --job-name=robomimic_tool_hang_absolute_actions
#SBATCH --output=/coc/flash7/nkra3/logs/sbatch_out/phd_project/sim/absolute_osc/robomimic_tool_hang_absolute_actions.out
#SBATCH --error=/coc/flash7/nkra3/logs/sbatch_err/phd_project/sim/absolute_osc/robomimic_tool_hang_absolute_actions.err

#!/bin/bash
#SBATCH --job-name=osc_desired_keypoint_franka2
#SBATCH --output=/srv/rl2-lab/flash7/zhenyang/logs/real_robot/pick_cube_11_08/osc_keypoint.out
#SBATCH --error=/srv/rl2-lab/flash7/zhenyang/logs/real_robot/pick_cube_11_08/osc_keypoint.err
...
config="osc_desired_keypoint.json"
